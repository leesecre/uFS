...
if benchmark_type == "ADPS":
    ...
    sync_op_list = [1]  # it is max for append
    # print("=========================================")
    # print(f"BENCHMARK TYPE: {benchmark_type}")
    # print(f"USING SYNC_OP_LIST: {sync_op_list}")
    # print("=========================================")
else:
    sync_op_list = [1]  # default setting for other benchmarks
    # print("=========================================")
    # print(f"BENCHMARK TYPE: {benchmark_type}")
    # print(f"USING SYNC_OP_LIST: {sync_op_list}")
    # print("=========================================")
...
for sync_op in sync_op_list:
    ...
    for num_app in num_app_list:
        ...
        print(f"SYNC_OP (1=latency): {sync_op}")
        print("=========================================")
        ...
        cur_log_dir = tc.get_proj_log_dir(
            tc.get_expr_user(), suffix=tc.get_ts_dir_name(), do_mkdir=True
        )
        mte_wr.bench_seq_sync_write(
            ...
            dump_iostat=(not cur_is_fsp and not cur_is_oxbow),
