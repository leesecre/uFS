...
def print_usage():
    print(
        'Usage: {} <ext4 | fsp> [is_move] [share] [perf] [numapp=]'.format(
            sys.argv[0]))
...
print('is_move? - {}'.format(str(cur_is_move)))
